...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "todo_table" ADD CONSTRAINT "todo_table_user_id_users_table_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users_table"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
